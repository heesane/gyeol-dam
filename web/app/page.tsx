...
export default function Home() {
  ...
  return <main id="top">
    ...
    <section className="reading-layout">
      ...
      <aside className="reading-preview"><div className="preview-head"><span>해월의 풀이</span><span>결과에서 보는 것</span></div><h3>네가 궁금한 걸<br />이렇게 풀어줄게.</h3><p className="preview-lede">{includesPalm ? '사주와 손금에서 같은 신호가 나오는지 먼저 확인하고, 지금 생활에서 바로 써먹을 수 있게 정리해.' : '태어난 때를 바탕으로 타고난 성향과 지금 들어온 흐름을 나눠서 봐.'}</p><ol><li><span>一</span><p><strong>타고난 성향</strong><span className="detail-stack"><span>결정을 내리는 방식</span><span>잘하는 일</span><span>완벽주의가 켜지는 순간</span></span></p></li><li><span>二</span><p><strong>손에 새겨진 기질</strong><span className="detail-stack"><span>주 손과 반대손</span><span>생각하는 방식</span><span>감정과 애정 표현</span></span></p></li><li><span>三</span><p><strong>지금 들어온 흐름</strong><span className="detail-stack"><span>잘 풀리는 일</span><span>늦어지는 일</span><span>흐름이 바뀌는 때</span></span></p></li><li><span>四</span><p><strong>일과 재능</strong><span className="detail-stack"><span>맞는 일의 방식</span><span>잘 맞는 조직</span><span>리더가 되었을 때</span></span></p></li><li><span>五</span><p><strong>돈과 사업</strong><span className="detail-stack"><span>돈을 버는 구조</span><span>돈이 새는 습관</span><span>사업과 투자의 함정</span></span></p></li><li><span>六</span><p><strong>연애와 결혼</strong><span className="detail-stack"><span>자꾸 끌리는 사람</span><span>반복되는 갈등</span><span>오래 갈 수 있는 관계</span></span></p></li><li><span>七</span><p><strong>앞으로의 큰 흐름</strong><span className="detail-stack"><span>20대 후반</span><span>30대</span><span>앞으로 몇 년의 변화</span></span></p></li><li><span>八</span><p><strong>지금 해야 할 선택</strong><span className="detail-stack"><span>밀어붙일 일</span><span>기다릴 일</span><span>버릴 습관</span><span>끝내야 할 것</span></span></p></li></ol><div className="cross-check"><ScanLine size={18} /><span>결과를 다 보고 나면<br /><strong>지금 할 일 세 가지만 남겨줄게.</strong></span></div></aside>
    </section>
